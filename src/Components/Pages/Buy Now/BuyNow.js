...
const BuyNow = () => {
    ...
    return (
        <div>
            ...
            <div className='items-center mt-6 space-y-12 lg:space-y-0 md:space-y-0 lg:grid lg:grid-cols-2 md:grid-cols-2 md:grid md:gap-x-4 lg:gap-x-4'>

            <div className='w-full  bg-cover'>
            <img className=' m-auto h-60' src="https://aavenir.com/wp-content/uploads/2021/10/Purchase-Order.jpg" alt="" />
            </div>

            <div className="max-w-md w-full m-auto ">
            <form className="shipping-form" onSubmit={handleSubmit(onSubmit)}>

            <input className='appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm' defaultValue={user.displayName || user.name} {...register("name")} placeholder='Your Name'/>

            <input className='appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900  focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm' defaultValue={user.email} {...register("email", { required: true })} placeholder='Your Email' />
